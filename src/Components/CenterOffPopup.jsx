...
export default function CenterOffPopup() {
  ...
  const goToCheckout = (type) => {
    ...
    window.location.href = `/books/fore/checkout?${params}`;
  };
  ...
  return (
    <div style={overlayStyle}>
      <div style={popupStyle}>
        ...
        <p className="xl:-mt-0 xl:mb-4" style={description}>
...
const title = { color: "#fff", fontSize: 26 };
const author = { fontSize: 14, opacity: 0.9 };
const bookImage = { width: 280, margin: "16px auto",  borderRadius: 14, marginBottom: '8px' };
