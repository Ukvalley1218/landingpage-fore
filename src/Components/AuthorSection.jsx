...
import mainimage from '../assets/visionary.webp'
...
const AuthorSection = () => {
  return (
    <div className="author-root" style={{
      width: "100%",
    ...
    text-align: center !important;
      ...
      <div id='about-author' className="author-content-wrapper" style={{
        ...
        <div className="author-content-left" style={{ flex: 1 }}>
          ...
          <div className="author-heading" style={{
            ...
            Meet The <span style={{ color: COLORS.gold }}>Visionary</span> 
            <br />
            Behind The Book
          </div>
          {/* Name */}
          ...
          <ul className="author-info-list text-justify" style={{
            ...
            <li>
              She is a <span style={{ fontWeight: 700 }}>visionary  author, businesswoman, speaker and philanthropist</span>, recognised for her pioneering work in Dubai’s real estate market. 

            </li>
            <li>
              As the Managing Director of <span style={{ fontFamily: "'Nunito Sans', sans-serif",fontWeight: 700 }}><span style={{fontFamily: 'Lato', fontWeight: 700}}>1</span>XL</span>, she leads sustainable, technology-driven projects. Her journey from humble beginnings to a prominent leader in the competitive Dubai market reflects her resilience, entrepreneurial spirit, and dedication to innovation.
      ...
      {/* Information section */}
      <section className="bg-[#1C1D20] py-10 px-5 lg:px-60 lg:mt-[80px]">
        <center className="lg:text-[40px] text-[35px] text-[#C89B3C]">
        ...
        <center className="lg:text-[22px] text-[20px] text-white mt-5 text-justify">
         ...
         for groundbreaking research on FDI and Dubai's Property Market Evolution, establishing her as a thought leader in the industry.
          <span className="text-[#FEFC86]"> Through <span className="font-nunito">1XL </span> Ventures,</span> she holds
           <span className="text-[#FEFC86]"> 2 patents awarded and 4 patents</span> pending for sustainable urban spaces, with the goal of transforming real estate with eco-friendly solutions that empower communities. Beyond business, her vision extends to the{" "}
          <span className="text-[#FEFC86]">Jainam Jivika Foundation (JJF), </span>
         where she actively works towards education, social upliftment, and creating lasting positive change for communities.
        </center>
        <center className="lg:text-[22px] text-[20px] text-white font-bold mt-5">
          Follow her journey and insights on @MamataJain<span style={{ fontFamily: "'Nunito Sans', sans-serif",fontWeight: 700 }}>1XL </span>
        </center>
