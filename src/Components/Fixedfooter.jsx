...
const FixedFooter = () => {
  ...
  useEffect(() => {
    ...
    fetch("https://ipapi.co/json/")
      ...
      .then((data) => {
        ...
        if (country === "IN") setPricing({ symbol: "₹", amount: "99", discount: 199 });
        else if (country === "AE") setPricing({ symbol: "AED", amount: "9", discount: 19 });
        else setPricing({ symbol: "$", amount: "4.99", discount: 9.99 });
      })
      .catch(() => setPricing({ symbol: "$", amount: "4.99", discount: 9.99 }));
  ...
  return (
    <div className="fixed-footer-bar">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-[#C89B3C] bg-[#FAFAF7] shadow-2xl rounded-t-xl">
        <div
          className="
      ...
      "
        >
          ...
          <div
            className="
          cta-dynamic-footer flex items-center justify-center
          flex-shrink-0
          px-3 sm:px-4
          rounded-md 
          lg:py-3
        ...
        "
          ...
          <div className="flex-1 flex items-center justify-center min-w-[120px] text-center">
            <div>
              <p className="text-black text-[10px] sm:text-[12px] md:text-[15px] mb-1">
                Offer Will Expire In
              </p>
              <div className="flex items-center justify-center gap-[4px] sm:gap-2">
                {/* Hours */}
                <div className="text-center">
                  <div className="text-[#C89B3C] font-bold text-[16px] sm:text-[20px] md:text-[32px] leading-none">
                ...
                {/* Colon */}
                <div className="text-[#C89B3C] font-bold text-[16px] sm:text-[20px] md:text-[24px] leading-none self-center">
                  :
                </div>
