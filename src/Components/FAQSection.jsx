...
const FAQSection = () => {
  ...
  const faqs = [
    {
      question: "Who should read Family Office Real Estate Simplified?",
      answer:
    ...
    {
      question:
        "Is this book suitable for someone new to family offices or real estate?",
      answer:
    ...
    {
      question: "Is the book based on global or regional examples?",
      answer:
    ...
    },
    {
      ...
      answer:
        "The book is available in both print and digital formats, giving you the flexibility to choose what works best for your learning style. Whether you prefer a physical copy for your bookshelf or a digital version for on-the-go access, we've got you covered.",
    },
    {
      question: "How is this book different from other real estate guides?",
      answer:
        "Unlike typical real estate guides, this book focuses on the critical intersection of property investing and tax optimization. You'll learn practical strategies for depreciation, 1031 exchanges, and wealth preservation—backed by real-world expertise from tax professionals who work with investors daily.",
    },
    {
  ...
  return (
    <>
      {/* faq section */}
      <div id="faqs" className="lg:min-h-screen bg-[#FAF6ED] py-8 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          {/* Header */}
          <h2 className="text-3xl sm:text-4xl md:text-[45px] font-tinos text-[#C89B3C] text-center mb-8 sm:mb-10 md:mb-12 px-2">
      ...
      {/* CTA Button */}
      <div className="flex justify-center items-center my-12 lg:my-20">
        {/* CTA Buttons */}
      ...
      <footer className="bg-[#1F2023] text-white mb-10 lg:mb-16">
        <div className="max-w-7xl mx-auto px-6 py-12 md:py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 ">
            {/* About the Book */}
            <div>
              <h3 className="text-[20px] font-bold mb-4 text-[#C89B3C]">About the Book</h3>
            ...
            <div className='xl:ml-20'>
              <h3 className="text-[20px] font-bold mb-4  text-[#C89B3C]">Quick Links</h3>
            ...
            <div className='xl:ml-10'>
              <h3 className="text-[20px] font-bold mb-4 text-[#C89B3C]">Legal</h3>
              <ul className="space-y-2">
                {[
                  { name: "Privacy Policy", path: "/books/fore/privacy-policy" },
                  { name: "Terms & Conditions", path: "/books/fore/terms" },
                  { name: "Return Policy", path: "/books/fore/return-policy" },
                  { name: "Shipping Policy", path: "/books/fore/shipping-policy" },
                  { name: "Payment Policy", path: "/books/fore/payment-policy" },
                  { name: "Cookie Policy", path: "/books/fore/cookie-policy" },
                ].map((item, idx) => (
                  <li key={idx}>
                    <a
                      href={item.path}
